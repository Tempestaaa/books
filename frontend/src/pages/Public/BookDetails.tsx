...
const BookDetails = () => {
  ...
  return (
    <article className="flex flex-col lg:flex-row container mx-auto lg:max-h-[calc(100svh-64px)] pt-4">
      <section className="lg:w-1/3 p-4 pt-0 flex flex-col gap-4 flex-shrink-0">
        <div className="w-1/2 lg:w-[60%] mx-auto overflow-hidden rounded-tr-3xl rounded-br-3xl rounded-md shadow-lg flex-shrink-0">
      ...
      <section className="overflow-y-auto flex-1 flex flex-col gap-4 divide-y scrollbar-none px-4">
        ...
        <div className="flex flex-col gap-8 pt-8 pb-16">
          <h1 className="capitalize text-2xl lg:text-4xl font-medium italic">
            Ratings & Reviews
          </h1>
          ...
          <div className="flex flex-col gap-4">
            ...
            {!isReviewing ? (
              ...
              <form
                ...
                className="w-full lg:w-3/4 px-4 mx-auto"
              >
                <Label>
                  Review:
                  <Textarea
